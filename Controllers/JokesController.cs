...
namespace JokesApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestion,JokeAnswers")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestion,JokeAnswers")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
